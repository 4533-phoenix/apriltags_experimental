...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--corners",
                        help="output corners file", default=None)
    parser.add_argument(
        "-fs", "--framestep", help="use every nth frame in the video", default=20, type=int)
    parser.add_argument("-max", "--max-frames",
                        help="limit the number of frames used for calibration", default=None, type=int)
